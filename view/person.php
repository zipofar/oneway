	...
	<body>
		<div class="site_container">
			<div class="aside">
				<div class="bl_table">
					<div>
						<div class="aside__person_img" style="background-image: url(img/<?php echo $person['avatar']; ?>);"></div>
						<div class="aside__person_name"><?php echo $person['name']." ".$person['fam']; ?><span><?php echo $person['function']; ?></span></div>
						<div class="aside__person_data">
							<ul>
								<li>
									<i class="i_icon-1"></i>
									<p><?php echo $person['city'].", ".$person['country']; ?></p>
								</li>
								<li>
									<i class="i_icon-2"></i>
					...
					<div>
						<div class="content__slider">
							<div id="slider">
                                ...
                                <?php for($i=0; $i<count($person['photos']); $i++) { ?>
								<div>
									<div class="slide__img" style="background-image: url(img/<?php echo $person['photos'][$i]['pathphoto'] ?>);"></div>
									<div class="slide__status">
										<input <?php if($person['photos'][$i]['is_like'] == 1) echo "checked"; ?> type="checkbox" id="like-<?php echo $i+1; ?>" name="like_status" onClick="setLike( <?php echo $person['photos'][$i]['id'] ?>, <?php echo $i+1; ?> )">

                                        <label for="like-<?php echo $i+1; ?>">
                                            ...
                                            <span><?php echo $person['photos'][$i]['count_likes'] ?></span>
